package com.suleymansah.triple.dictionary;
...
import static com.suleymansah.triple.dictionary.GlobalVars.BASE_REQ_URL;
import static com.suleymansah.triple.dictionary.GlobalVars.DEFAULT_LANG_POS;
import static com.suleymansah.triple.dictionary.GlobalVars.LANGUAGE_CODES;
...
public class TranslationActivity extends AppCompatActivity implements TextToSpeech.OnInitListener{
    ...
    private String mLanguageCodeFrom = "tr";                //    Language Code (From)
